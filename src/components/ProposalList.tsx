...
import { Title, MarkerBar, CategoryBar, Text, Button, Badge } from "@tremor/react";
import { formatToken } from "@utils/numbers";
import { Card, Skeleton } from "@components/common";
import { TokenVotingProposalListItem, useFetchProposals } from "@daobox/use-aragon";
import { daoAddress } from "../constants";

export function ProposalList() {
  const { data: proposals } = useFetchProposals({ daoAddressOrEns: daoAddress });
